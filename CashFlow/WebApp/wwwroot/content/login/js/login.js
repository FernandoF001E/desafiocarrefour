base_controller = "authentication";
base_form = "frmLogin";
...
$("#btnLogin").click(function () {
    ...
    $.ajax({
        url: base_url + '/' + base_controller + '/validate',
        type: 'Post',
        data: dataForm,
        dataType: 'json',
        success: function (response) {
            ...
            if (obj != null && parseInt(obj.code) == 0) {
                if (obj.data.type == 1) {
                    ...
                    window.location = base_url + '/company/select';
                } else {
                    window.location = base_url + '/dashboardsupplier/index';
                }
